...
class S {
  ...
  static const Map<String, List<String>> _t = {
    ...
    'biller': ['যাকে দেওয়া হলো', 'Biller'],
    'biller_account': ['মিটার / হিসাব নম্বর', 'Meter / account no.'],
    'biller_token': ['টোকেন', 'Token'],
    'copied': ['কপি হয়েছে', 'Copied'],
    'taken_in_cash': ['কাস্টমারের কাছ থেকে নগদে নিই', 'I take this from the customer in cash'],
    'taken_in_cash_sub': ['বিল পে-তে দোকান যে ৫ টাকা সার্ভিস চার্জ নেয় — সেটা হাতে আসে, ওয়ালেটে নয়। চালু থাকলে টাকাটা নগদে যোগ হবে।', 'The service charge a shop takes on a bill comes into the drawer, not the wallet. On, and it is added to cash.'],
    'in_cash_short': ['নগদে', 'in cash'],
    'service_charges': ['সার্ভিস চার্জ (বিল পে)', 'Service charge (bill pay)'],
    'service_charges_sub': ['প্রতি বিলে দোকান কত রাখে। অপারেটর অনুযায়ী আলাদা হতে পারে — চাপ দিয়ে বদলান।', 'What the shop keeps per bill. It can differ per operator — tap to change.'],
    'add_biller_rate': ['এক বিলারের জন্য আলাদা চার্জ', 'A different charge for one biller'],
    'add_biller_rate_sub': ['যেমন নেসকোতে ৫ টাকা, ওয়াসায় ১০ টাকা', 'e.g. ৳5 for NESCO, ৳10 for WASA'],
    'biller_rule': ['বিলার (ফাঁকা = সব বিলার)', 'Biller (blank = every biller)'],
    'biller_rule_help': ['মেসেজে যা লেখা থাকে তার অংশ — NESCO লিখলে NESCOPre আর NESCOPost দুটোতেই চলবে।', "Part of what the message says — NESCO covers both NESCOPre and NESCOPost."],
    'in_wallet_short': ['ওয়ালেটে', 'to the wallet'],
